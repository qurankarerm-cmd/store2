...
function EditProduct() {
    ...
    () => productsAPI.getById(id),
    {
      ...
      onSuccess: (data) => {
        ...
        setFormData({
          ...
          processingTime: productData.processingTime || '3-5 أيام',
          tags: productData.tags ? productData.tags.join(', ') : '',
          stock: productData.stock || 'متوفر',
      ...
      <Layout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-500">لم يتم العثور على المنتج المطلوب</p>
          </div>
        </div>
      </Layout>
    );
  ...
  return (
    <>
      <Head>
        <title>تعديل المنتج - {product.product?.name} - لوحة التحكم</title>
      </Head>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      تعديل معلومات المنتج: {product.product?.name}
                    </p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer">
                      ...
                      <p className="text-lg font-medium text-gray-900 mb-2">
                        {isUploading ? 'جاري الرفع...' : 'اسحب الصور هنا أو اضغط لإضافة المزيد'}
                      </p>
...
export default withAuth(EditProduct, ['products:update']);